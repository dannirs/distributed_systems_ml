...
class JobManager:
    ...
    def get_task_response(self, response):
        ...
        self.master.client_registry[(response["params"]["client_addr"][0], response["params"]["client_addr"][1])]["task_status"] = False
        ...
        if response["params"]["status"] == "404":
            ...
            del self.tasks_pending_results[response["params"]["task_id"]]
